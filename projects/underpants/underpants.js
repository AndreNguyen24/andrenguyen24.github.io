...
// Objective1: check to see if collection is an array
    if (Array.isArray(collection)) {
// Objective1: access array 
        for (let i = 0; i < collection.length; i++) {
// Objective1: calling func with args of e, i, collection
            func(collection[i], i, collection);
        }
    } else {
// Objective2: access object
        for (let key in collection) {
// Objective2: calling func with args of prop value, key, collection
...
_.pluck = (array, property) => {
    return _.map(array, function(object, index, arr) {
...
_.extend = (object1, ...objects) => {
    _.each(objects, function(obj, index, array) {
